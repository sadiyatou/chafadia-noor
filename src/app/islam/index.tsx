...
const LESSONS: Lesson[] = [
  ...
  {
    id: 'washing-deceased-essential3',
    title: 'Washing and Shrouding the Deceased',
    category: 'Death',
    type: 'video',
    media: assets.essential3,
    icon: '🧼',
    level: 'Practical',
    duration: 'Video',
    essential: true,
    summary:
      'A respectful lesson on washing and preparing the deceased according to Islamic manners.',
    points: [
      'The deceased must be treated with dignity.',
